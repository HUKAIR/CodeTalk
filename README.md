...
> **可复跑工具 + 干净样本复验**(`docs/discovery/2026-06-27-护城河盲测-可复跑+干净样本.md`):工具默认
> 自动挑「泄漏最低」的干净 commit(why 不在 diff)跑反推;本仓 3 个干净样本上**反推 3/3 漏真决策、
> 2/3 露骨编造**(含幻觉数字、整条认错主题)。诚实口径:N=3、本仓、人工判读、未自动打分。

"""codetalk CLI — 解析参数并分发到 commands.py 的各子命令实现。"""
import argparse
import logging
...
def _build_parser():
    ...
    asq.add_argument("target", help='文件或 文件:起-止,如 codetalk/llm.py:72-78')
    ...
    blm.add_argument("target", help='文件或 文件:起-止,如 codetalk/llm.py:72-78')

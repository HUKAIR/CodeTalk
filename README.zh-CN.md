...
# 本仓自己使用 CodeTalk——每个 commit 都有决策记录行
...
对每个改动过该文件的 commit，你会看到：**为什么**、**做了哪些决定**、**否决了哪些替代方案**——全部逐字取自 commit 记录，零 LLM。一条命令就是全部卖点。

...
# or: code --install-extension vscode-codetalk-0.3.1.vsix
...
```bash
# macOS Cursor:
/Applications/Cursor.app/Contents/Resources/app/bin/cursor --install-extension vscode-codetalk-0.3.1.vsix

# macOS VS Code:
"/Applications/Visual Studio Code.app/Contents/Resources/app/bin/code" --install-extension vscode-codetalk-0.3.1.vsix
```

...
TOOLS = [
    {"name": "codetalk_ask",
     ...
     "inputSchema": {"type": "object", "properties": {
         "target": {"type": "string",
                    "description": "File or file:start-end, e.g. codetalk/llm.py:72-78"},
         ...
         "required": ["question"]},
     "annotations": {"title": "codetalk ask", "readOnlyHint": True,
    ...
    {"name": "codetalk_blame",
     ...
     "inputSchema": {"type": "object", "properties": {
         ...
         "project": {"type": "string", "description": "Project path (default: cwd)"}},
         "required": []},
     "annotations": {"title": "codetalk blame", "readOnlyHint": True,
                     "destructiveHint": False, "openWorldHint": False}},
    ...
    {"name": "codetalk_graph",
     ...
     "inputSchema": {"type": "object", "properties": {
         "project": {"type": "string", "description": "Project path (default: cwd)"}},
         "required": []},
     "annotations": {"title": "codetalk graph", "readOnlyHint": True,
                     "destructiveHint": False, "openWorldHint": False}},
    ...
    {"name": "codetalk_search",
     ...
     "inputSchema": {"type": "object", "properties": {
         ...
         "project": {"type": "string", "description": "Project path (default: cwd)"}},
         "required": ["question"]},
     "annotations": {"title": "codetalk search", "readOnlyHint": True,
                     "destructiveHint": False, "openWorldHint": False}},
    ...
    {"name": "codetalk_drift",
     ...
     "inputSchema": {"type": "object", "properties": {
         ...
         "project": {"type": "string", "description": "Project path (default: cwd)"}},
         "required": []},
     "annotations": {"title": "codetalk drift", "readOnlyHint": True,
                     "destructiveHint": False, "openWorldHint": False}},

    {"name": "codetalk_prompts",
     "description":
     ...
     "inputSchema": {"type": "object", "properties": {
         ...
         "project": {"type": "string", "description": "Project path (default: cwd)"}},
         "required": []},
     "annotations": {"title": "codetalk prompts", "readOnlyHint": True,
                     "destructiveHint": False, "openWorldHint": False}},
    ...
    {"name": "codetalk_adr",
     ...
     "inputSchema": {"type": "object", "properties": {
         ...
         "project": {"type": "string", "description": "Project path (default: cwd)"}},
         "required": []},
     "annotations": {"title": "codetalk adr", "readOnlyHint": True,
                     "destructiveHint": False, "openWorldHint": False}},
]
...
def project_path(arguments, default_project, stderr):
    ...
    print(f"codetalk mcp: tool on project {pp}", file=stderr)
    return pp
